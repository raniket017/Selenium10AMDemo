...
/**
 * This class store methods related selenium WebDriver
 * @author ranik
 *
 */
public class WebDriverUtility {
/**
 * This method wait for an element implicitly
 * @param driver 
 */
	...
	/**
	 * This method wait for the title
	 * @param driver
	 * @param title
	 */
	...
	public void waitForElementToCustom(WebDriver driver,int pollingTime,WebElement element)
	{
		...
		wait.pollingEvery(Duration.ofMillis(IPathConstant.POLLINGPERIOD));
		wait.until(ExpectedConditions.elementToBeClickable(element));
	}
